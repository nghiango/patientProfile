...
public class TypeMedicineController {
    ...
    public TypeOfMedicine updateMedicine(@PathVariable String typeMedicineId, @RequestBody TypeOfMedicine typeMedicine) {
        typeMedicineService.updateTypeMedicine(typeMedicineId, typeMedicine);
        return null;
    }
